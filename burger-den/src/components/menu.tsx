...
const Menu = () => {
  ...
  return (
    <div>
      ...
      <h2 className="text-4xl font-bold text-center mb-10 text-[#642800]">Our Menu</h2>
      
      {/* Menu Items */}
      <section className="menu-items py-12 bg-[#ebccc2]">
        <div className="flex flex-wrap justify-center gap-8">
          {/* Menu Item: Cheese Burger */}
          <div className="bg-white p-6 rounded-xl shadow-lg w-64 text-center m-4">
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              <img src="/images/cheeseBurger.jpg" alt="Cheese Burger" className="menu-item-img mb-4 rounded-t-xl" />
            </div>
            <h3 className="text-2xl font-semibold mb-2 text-[#642800]">Cheese Burger</h3>
            <p className="text-xl font-medium">$10</p>
            <button className="bg-[#a1501a] text-white px-6 py-3 rounded hover:bg-[#8b3d0c]" onClick={() => addToCart("Cheese Burger", 10)}>Add to Cart</button>
          </div>

          {/* Menu Item: Bacon Burger */}
          <div className="bg-white p-6 rounded-xl shadow-lg w-64 text-center m-4">
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              <img src="/images/baconBurger.jpg" alt="Bacon Burger" className="menu-item-img mb-4 rounded-t-xl" />
            </div>
            <h3 className="text-2xl font-semibold mb-2 text-[#642800]">Bacon Burger</h3>
            <p className="text-xl font-medium">$12</p>
            <button className="bg-[#a1501a] text-white px-6 py-3 rounded hover:bg-[#8b3d0c]" onClick={() => addToCart("Bacon Burger", 12)}>Add to Cart</button>
          </div>

          {/* Menu Item: Chicken Sandwich */}
          <div className="bg-white p-6 rounded-xl shadow-lg w-64 text-center m-4">
            <div className="bg-white rounded-xl overflow-hidden shadow-md">
              <img src="/images/chickenSandwich.jpg" alt="Chicken Sandwich" className="menu-item-img mb-4 rounded-t-xl" />
            </div>
            <h3 className="text-2xl font-semibold mb-2 text-[#642800]">Chicken Sandwich</h3>
            <p className="text-xl font-medium">$9</p>
            <button className="bg-[#a1501a] text-white px-6 py-3 rounded hover:bg-[#8b3d0c]" onClick={() => addToCart("Chicken Sandwich", 9)}>Add to Cart</button>
          </div>
        </div>
      </section>
